...
public class TclConsoleReds extends TclComponent {
  ...
  public TclConsoleReds() {
    ...
    final com.cburch.logisim.instance.Port[] inputs = new Port[inputsDesc.size()];
    final com.cburch.logisim.instance.Port[] outputs = new Port[outputsDesc.size()];

    for (int i = 0; i < inputsDesc.size(); i++) {
      final com.cburch.logisim.std.tcl.TclComponent.PortDescription desc = inputsDesc.get(i);
    ...
    for (int i = 0; i < outputsDesc.size(); i++) {
      final com.cburch.logisim.std.tcl.TclComponent.PortDescription desc = outputsDesc.get(i);
