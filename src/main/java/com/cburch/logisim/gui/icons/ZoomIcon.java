...
public class ZoomIcon extends BaseIcon {
  ...
  protected void paintIcon(Graphics2D g2) {
    ...
    final int scaledOne = AppPreferences.getScaled(1);
    final int scaledEleven = AppPreferences.getScaled(10);
    ...
    final double xyPoint = AppPreferences.getScaled(6.0 + Math.sqrt(12.5));
