...
public class HdlWires {
  ...
  public HdlWires addAllWires(Map<String, Integer> wires) {
    for (java.lang.String wire : wires.keySet()) myWires.add(new Wire(WIRE, wire, wires.get(wire)));
    return this;
  }
  ...
  public int get(String wireName) {
    for (com.cburch.logisim.fpga.hdlgenerator.HdlWires.Wire wire : myWires) if (wire.getName().equals(wireName)) return wire.getNrOfBits();
