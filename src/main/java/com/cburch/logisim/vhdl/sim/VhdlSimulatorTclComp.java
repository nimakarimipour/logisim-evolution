...
public class VhdlSimulatorTclComp {
  ...
  public void generate(List<Component> comps) {
    ...
    final java.lang.StringBuilder compFiles = new StringBuilder();
    ...
    for (final com.cburch.logisim.comp.Component comp : comps) {
      if (comp.getFactory().getClass().equals(VhdlEntity.class)
        ...
        final com.cburch.logisim.instance.InstanceState state = vsim.getProject().getCircuitState().getInstanceState(comp);
        final com.cburch.logisim.comp.ComponentFactory fact = comp.getFactory();
