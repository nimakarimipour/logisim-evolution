...
public class VhdlSimulatorVhdlTop {
  ...
  public void generate(List<Component> comps) {
    ...
    for (final com.cburch.logisim.comp.Component comp : comps) {
      final com.cburch.logisim.instance.InstanceState state = vhdlSimulator.getProject().getCircuitState().getInstanceState(comp);

      final com.cburch.logisim.comp.ComponentFactory fac = comp.getFactory();
      String vhdlEntityName;
      final java.util.ArrayList<com.cburch.logisim.vhdl.base.VhdlParser.PortDescription> myPorts = new ArrayList<VhdlParser.PortDescription>();
      if (fac instanceof VhdlEntity) {
        ...
        for (final com.cburch.logisim.instance.Port port :
       ...
       * Create ports
       */
      for (final com.cburch.logisim.vhdl.base.VhdlParser.PortDescription port : myPorts) {
        if (!firstPort) {
          ports.append(";");
          ports.append(lineSeparator);
        } else {
        ...
        final java.lang.String portName = vhdlEntityName + "_" + port.getName();
        ports
            .append("      ")
            .append(portName)
            .append(" : ")
