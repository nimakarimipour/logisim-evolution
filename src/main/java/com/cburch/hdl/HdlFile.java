...
public class HdlFile {
  ...
  public static void open(File file, HdlContentEditor editor) throws IOException {
    ...
    try (final java.io.BufferedReader in = new BufferedReader(new FileReader(file))) {
  ...
  public static void save(File file, HdlContentEditor editor) throws IOException {
    ...
    try (final java.io.BufferedWriter out = new BufferedWriter(new FileWriter(file))) {
      final java.lang.String data = editor.getText();
