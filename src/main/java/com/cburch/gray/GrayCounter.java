...
class GrayCounter extends InstanceFactory {
  ...
  public GrayCounter() {
    ...
    // 16x16 image.
    final java.net.URL url = getClass().getClassLoader().getResource("com/cburch/gray/counter.gif");
  ...
  public void paintInstance(InstancePainter painter) {
    ...
    if (painter.getShowState()) {
      final com.cburch.logisim.data.BitWidth width = painter.getAttributeValue(StdAttr.WIDTH);
      final com.cburch.gray.CounterData state = CounterData.get(painter, width);
